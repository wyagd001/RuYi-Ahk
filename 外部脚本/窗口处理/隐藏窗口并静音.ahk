...
Boss_Windy_CurWin_id := Windy_CurWin_id
...
Receive_WM_COPYDATA(wParam, lParam)
{
	...
	Windy_CurWin_id := StrGet(StringAddress)  ; 从结构中复制字符串.
	;tooltip % Win " - 1000" 
	SetTimer 窗口还原或隐藏, -300 
	return true
}

窗口还原或隐藏:
if Boss_Windy_CurWin_id
{
	WinShow, ahk_id %Boss_Windy_CurWin_id%
	sleep 200
	AppVolume(Windy_CurWin_ProcName).ToggleMute()
	Boss_Windy_CurWin_id := ""
}
else
{
	Boss_Windy_CurWin_id := Windy_CurWin_id
