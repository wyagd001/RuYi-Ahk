...
class Vis2 {
   ...
   class provider {
      ...
      class Tesseract {
         ...
         static leptonica := GetFullPathName(A_ScriptDir "\..\..\引用程序\其它资源\leptonica_util\leptonica_util.exe")
         static tesseract := GetFullPathName(A_ScriptDir "\..\..\引用程序\其它资源\tesseract\tesseract.exe")
         static tessdata_best := GetFullPathName(A_ScriptDir "\..\..\引用程序\其它资源\tesseract\tessdata_best")
         static tessdata_fast := GetFullPathName(A_ScriptDir "\..\..\引用程序\其它资源\tesseract\tessdata_fast")
         ...
         OCR(image, language:="", options:=""){
            ...
            try {
               ...
               MsgBox, 16,, % "发生错误!`n`n描述: " e.what "`n文件: " e.file
                  . "`n行: " e.line "`n错误信息: " e.message "`n额外信息: " e.extra
            }
            finally {
               this.cleanup()
               text.base.google := ObjBindMethod(Vis2.Text, "google")
         ...
         convert(in:="", out:="", fast:=1){
            ...
            if !(FileExist(this.tesseract))
               throw Exception("Tesseract 文件不存在!",, this.tesseract)
            ...
            if !(FileExist(out))
               throw Exception("Tesseract 运行失败.",, _cmd)
         ...
         preprocess(in:="", out:=""){
            ...
            if !(FileExist(this.leptonica))
               throw Exception("Leptonica 文件不存在",, this.leptonica)
