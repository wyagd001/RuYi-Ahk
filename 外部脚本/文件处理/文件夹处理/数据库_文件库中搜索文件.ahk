...
Gui, Add, ListView, xs+1 HWNDhistoryLV vhistoryLV  LV0x4000 h400 w650, 名称|路径|大小|修改时间  ;ghistoryLV
...
Gui, Add, Button, xp+438 yp h30 gupdateMlib, 更新文件库
Gui, Show, w670 h480, 文件库中搜索文件
if CandySel
gosub flib_Search
return
