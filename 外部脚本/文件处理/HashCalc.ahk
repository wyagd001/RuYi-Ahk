...
Gui, Add, Text, xm ym w100, 数据格式:
Gui, Add, Text, x+10 ym w390, 数据:
Gui, Add, DropDownList, xm y+6 w100 AltSubmit vDDL, 字符串|Hex|文件||
Gui, Add, Edit, x+10 yp w390 vStr, %1%
Gui, Add, Button, x+3 yp w80 h23 gFile vFile, 文件
...
Gui, Font,,
Gui, Add, Button, x+36 yp-1 w80 gCalculate, 计算
Gui, Add, Button, x+3 yp w80 gClear, 清除
Gui, Add, Button, x+3 yp w80 gClose, 关闭
