...
{
	Gui,66:Default 
	if Fileexist(CandySel2)
	{
		FileEncoding, % File_GetEncoding(CandySel2)
		fileread, FileR_TFC2, %CandySel2%
		FileEncoding
		GuiControl,, textfile2, %CandySel2%
		t2.SetText(FileR_TFC2)
	}
	else
	{
		t2.SetText(CandySel2)
	}
