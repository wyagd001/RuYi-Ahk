...
TaskUser(hfile, prams:="")
{
	...
	Run, %A_WinDir%\System32\schtasks.exe /CREATE /TN %Title% /TR "\"%Path%\%Target%\" \"%prams%\"" /sc ONCE /RU %UserID% /st 00:00 ,,hide
	
	; This will Run the task
	Run, %A_WinDir%\System32\schtasks.exe /Run /TN %Title% ,,hide
