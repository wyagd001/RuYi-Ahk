...
; ---------------------------------------------------------------------------------------
Gui, Add, Button, xm y+20 w160 h80 vBtn1 hWndhBtn1 gblockkeyboard, % "解除屏蔽"
IBBtnStyles1 := [ [0, 0x80F0B9B8, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2]      ; normal
			   , [0, 0x80C6E9F4, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2]      ; hover
			   , [0, 0x8046B8DA, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2]      ; pressed
			   , [0, 0x80F0F0F0, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2] ]
IBBtnStyles2 := [ [0, 0x80C6E9F4, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2]      ; normal
			   , [0, 0x80F0B9B8, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2]      ; hover
			   , [0, 0x80E27C79, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2]      ; pressed
			   , [0, 0x80F0F0F0, , , 8, 0xFFF0F0F0, 0x80D43F3A, 2] ]
ImageButton.Create(hBtn1, IBBtnStyles1*)


Gui, Add, Button, x+20 yp w160 h80 vBtn2 hWndhBtn2 gGuiClose, % "退出"
...
ImageButton.Create(hBtn2, IBBtnStyles*)
; ---------------------------------------------------------------------------------------
...
if (block=1)
{
	GuiControl,, Btn1, 解除屏蔽
	ImageButton.Create(hBtn1, IBBtnStyles1*)
	SetTimer blockKeyboardf, -1
}
Else if (block=0)
{
	InHook.Stop()
	GuiControl,, Btn1, 屏蔽
	ImageButton.Create(hBtn1, IBBtnStyles2*)
}
Return
