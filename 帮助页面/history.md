...
### <span id="3.0">3.0 - 2025/09/01</span>
1. 修改 自动运行动作定时动作  
.01 新增 定时动作支持指定 某月某日, 每月某日, 每月月底这三种定时类型  
2. 修改 配置文件  
...
.01 新增 外部脚本共享库 /lib/RuYi.ahk  
.01 新增 外部脚本共享库 File_CpTransform.ahk  
.01 新增 外部脚本共享库 AutoXYWH.ahk  
.01 新增 外部脚本共享库 OpenedFolder.ahk  
.01 新增 粘贴到选中文件.ahk  
.02 新增 文件_gps.ahk  
.03 新增 Winmerge.ahk  
.03 新增 文件夹_局域网共享(Net Share).ahk  
.03 新增 文件夹_删除局域网共享.ahk  
.03 新增 文件夹_局域网共享(API).ahk  
.03 新增 文件夹_局域网共享(WMI).ahk  
.03 新增 文件夹_局域网共享跳转.ahk  
.03 新增 旧版如意自定义动作配置转新版.ahk  
10. 修复 Bug  
