...
|1720|否|粘贴到文件|选中文件|将剪贴板内容粘贴到选中的文件(先删除后粘贴)|粘贴到选中文件.ahk|
|1721|否|GPS|选中文件夹|查看选中文件夹中图片文件中的GPS信息|文件_gps.ahk|
|1722|否|对比1&2|选中文件|将选中的文件使用 WinMerge 打开(左侧)或将文件路径放入右侧|WinMerge.ahk|
|1725|否|共享|选中文件夹|局域网共享选中文件夹(完全)并设置文件权限为完全控制|文件夹_局域网共享(Net Share).ahk|
|1726|否|删除共享|选中文件夹|删除选中局域网共享文件夹的共享|文件夹_删除局域网共享.ahk|
|1727|否|共享|选中文件夹|局域网共享选中文件夹(完全控制)并设置NTFS权限everyone 完全控制|文件夹_局域网共享(API).ahk|
|1728|否|共享|选中文件夹|局域网共享选中文件夹(只读)并设置NTFS权限everyone完全控制|文件夹_局域网共享(WMI).ahk|
|1729|否|转到目录|选中文件夹|跳转到选中局域网共享文件夹的实际文件夹路径|文件夹_局域网共享跳转.ahk|
