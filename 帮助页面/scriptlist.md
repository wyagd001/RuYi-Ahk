...
|1681|否|转农历|选中文本|查看选中日期的农历时间|数字_时间转农历.ahk|
...
|1697|否|设置图标|选中文件夹|设置选中文件夹的图标|设置文件夹图标.ahk|
|1699|否|微信下载|无条件|打开微信的下载目录|微信下载目录.ahk|
|1700|否|QQ下载|无条件|打开QQ的下载目录|QQ下载目录.ahk|
|1702|否|拼音(WV2)|选中文件|使用 WebView2 显示选中文本的拼音|汉字显示拼音(WebView2).ahk2|
|1707|否|关闭所有|任意窗口|关闭所有窗口(只限于任务栏上可见的窗口)|关闭所有窗口.ahk|
|1708|否|计算BMI|无条件@数字|根据身高体重计算身体质量指数(BMI)|身体质量指数(BMI).ahk|
|1711|否|经纬度|无条件@数字|经纬度换算|经纬度转换.ahk|
|1714|否|中转站|无条件@剪贴板|显示一个置顶窗口,可以将复制的文本,位图,文件(也能拖拽文件到该窗口)暂存其中,通过拖拽将其在其他窗口打开|剪贴板中转站.ahk|
|1720|是|粘贴到文件|选中文件|将剪贴板内容粘贴到选中的文件(先删除后粘贴)|粘贴到选中文件.ahk|
|1721|否|GPS|选中文件夹|查看选中文件夹中图片文件中的GPS信息|文件_gps.ahk|
|1722|否|对比1&2|选中文件|将选中的文件使用 WinMerge 打开(左侧)或将文件路径放入右侧|WinMerge.ahk|
|1725|是|共享|选中文件夹|局域网共享选中文件夹(完全)并设置文件权限为完全控制|文件夹_局域网共享(Net Share).ahk|
|1726|是|删除共享|选中文件夹|删除选中局域网共享文件夹的共享|文件夹_删除局域网共享.ahk|
|1727|是|共享|选中文件夹|局域网共享选中文件夹(完全控制)并设置NTFS权限everyone 完全控制|文件夹_局域网共享(API).ahk|
|1728|是|共享|选中文件夹|局域网共享选中文件夹(只读)并设置NTFS权限everyone完全控制|文件夹_局域网共享(WMI).ahk|
|1729|是|转到目录|选中文件夹|跳转到选中局域网共享文件夹的实际文件夹路径|文件夹_局域网共享跳转.ahk|
|1732|否|转新配置|选中文件|将选中的旧版如意自定义动作配置(3.0.0.2-)转为新版(3.0.0.3+)|旧版如意自定义动作配置转新版.ahk|
|1733|否|edge新|特定窗口|edge-chrome新标签页打开收藏|edge-chrome新标签页打开收藏.ahk"|
|1735|是|结束改名|任意窗口|结束指定进程并改名|结束指定进程并改名.ahk|
